 ...
 *
 * Umschalten: GuiTheme.toggleTheme() → danach GUI neu aufbauen.
 */
public final class GuiTheme {
    ...
    /** Schaltet zwischen Dark und Light um. Gibt true zurück = jetzt dark. */
    public static boolean toggleTheme() {
        darkMode = !darkMode;
        return darkMode;
    }

    // ── Dynamische Farb-Accessoren ────────────────────────────────────────
    ...
    // ── DARK THEME ────────────────────────────────────────────────────────
    private static final Color D_BG          = new Color(0x08, 0x0A, 0x09);  // tiefstes Schwarz
    private static final Color D_PANEL_BG    = new Color(0x0F, 0x12, 0x10);  // Kasten-Bg
    private static final Color D_SIDEBAR_BG  = new Color(0x0B, 0x0E, 0x0C);  // Sidebar
    ...
    private static final Color D_FG          = new Color(0xEC, 0xE8, 0xDC);  // heller Primärtext
    ...
    // ── Statische Farben (theme-unabhängig) ───────────────────────────────
    /** Haupt-Akzent: warmes Amber-Gold */
    ...
    // Statische Aliase für Legacy-Code (lesen aktuellen Theme-Wert)
    public static Color BG         = D_BG;
    public static Color PANEL_BG   = D_PANEL_BG;
    public static Color SIDEBAR_BG = D_SIDEBAR_BG;
    public static Color BTN_BG     = D_BTN_BG;
    public static Color BTN_HOV    = D_BTN_HOV;
    public static Color BTN_ACT    = new Color(0x35, 0x40, 0x30);
    public static Color BORDER     = D_BORDER;
    public static Color BORDER_LT  = D_BORDER_LT;
    public static Color FG         = D_FG;
    public static Color FG_DIM     = D_FG_DIM;
    public static Color FG_DEAD    = new Color(0x30, 0x35, 0x30);
    public static Color ROW_EVEN   = D_ROW_EVEN;
    public static Color ROW_ODD    = D_ROW_ODD;
    public static Color ROW_SEL    = new Color(0x2A, 0x32, 0x20);

    // OS-Farben (unveränderlich)
    ...
    /**
     * Aktualisiert alle statischen Aliase nach einem Theme-Wechsel.
     * Muss nach toggleTheme() aufgerufen werden, bevor die GUI neu gezeichnet wird.
     */
    public static void applyToStatics() {
        ...
        FG_DEAD   = darkMode ? new Color(0x30,0x35,0x30) : new Color(0xB8,0xB4,0xA8);
        BTN_ACT   = darkMode ? new Color(0x35,0x40,0x30) : new Color(0xC4,0xC0,0xB4);
    }

    public static Color osColor(String os) {
        if (os == null) return FG;
        ...
        if (l.startsWith("android")||l.contains("samsung")||l.contains("xiaomi")
