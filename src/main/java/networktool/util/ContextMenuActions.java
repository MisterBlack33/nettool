...
public final class ContextMenuActions {
    ...
    public static void sendWakeOnLan(String ip, String mac, GuiMenuHandler menuHandler, GuiOutputPanel output) {
    ...
    public static void promptAndSendMessage(String ip, GuiMenuHandler menuHandler) {
